  ...
  return (
    <div>
      ...
      <p>
        ...
        données personnelles des utilisateurs conformément au Règlement général
      ...
      <p>
        ...
        sauf si la loi exige une période de conservation plus longue. Nous
        mettons en place des mesures de sécurité appropriées pour protéger les
        données personnelles contre tout accès non autorisé ou toute
        divulgation.
      </p>
      ...
      <p>
        ...
        préalable. Cependant, nous pouvons divulguer vos données personnelles à
        des tiers dans les cas suivants :
      </p>
      <ul>
        <li>Si cela est nécessaire pour fournir les services demandés</li>
        <li>
          Si la loi l'exige ou si nous sommes tenus de le faire par une autorité
          compétente
        </li>
      </ul>
      ...
      <p>
        ...
        l'utilisation de vos données personnelles. Vous pouvez également vous
        opposer au traitement de vos données personnelles ou demander leur
        portabilité. Pour exercer ces droits, veuillez nous contacter à [adresse
      ...
      <p>
        ...
        autre. Les modifications prendront effet dès leur publication sur cette
        page. Nous vous encourageons à consulter régulièrement cette page pour
        prendre connaissance des éventuelles modifications. Voici les Conditions
